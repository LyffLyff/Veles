...
static func set_cover(var img_path : String, var song_path : String, var mime_type : String) -> void:
	var x : Tagging = Tagging.new()
	var _err = x.set_cover(img_path, song_path, mime_type)
