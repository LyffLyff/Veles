...
static func identify_image_file(var data : String) -> int:
	...
	var return_codes : PoolIntArray = [1,0,0,0,0,0,0,2]
...
static func get_music_format_from_data(var max_check_data : String) -> int:
	...
	#			Opus   -> 4F 70 75 73
	# Mp4
	#	   ....���ftypM4A -> 00 00 00 1C 66 74 79 70 4D 34 41
	# Ogg Vorbis [0]:
	#			vorbis -> 76 6f 72 62 69 73
	#			Ogg	   -> 4f 67 67
	var unique_id_bytes : PoolStringArray = ["69736f366d703431","494433","41504943","766f72626973","4f6767","57415645","52494646","0000001C667479704D3441"]
	var return_codes : PoolIntArray = [-1,1,1,0,0,2,2,3,3,5]
