...
func genre(var song_path : String, var genre : String) -> bool:
	...
	return Tags.get_genre(song_path).to_upper() == genre.to_upper();
...
func album(var song_path : String, var album_title : String) -> bool:
	...
	return Tags.get_album(song_path).to_upper() == album_title.to_upper();


func includes_artist(var song_path : String, var artist : String) -> bool:
	return artist.to_upper() in AllSongs.get_song_artist(AllSongs.get_main_idx(song_path)).to_upper();
...
func includes_either_artist(var song_path : String, var artists : PoolStringArray) -> bool:
	...
	for artist in artists:
		if artist.to_upper() in song_artists.to_upper():
			return true;
	return false;
