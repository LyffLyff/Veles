...
Veles is an Open Source and Free Application created by LyffLyff and licensed und the GNU General Public License v3.0, it can be used to play, organize, download and tag music files.
...
Github Project: [url]https://github.com/LyffLyff/Veles[/url]
"""
}
...
by reading some of it's metadata and being displayed under all songs, they won't be possible
...
By either adding multiple songs or selecting multiple songs on a playlist using the SHIFT-Key, Veles will allow you to tag multiple songs at the same time.
...
Icons by [url]https://roundicons.com/[/url], License: [url]https://roundicons.com/usage-license/[/url]
...
[url]https://godotengine.org/license[/url]
	...
	"GNU GPLv3 " : 
		""" 
[center][url]https://choosealicense.com/licenses/gpl-3.0/[/url]
		"""
}
